-- INSERT INTO audit.dbl_info (dbl_id, agreement_id) VALUES
...
VALUES 
    (246069), -- FBV | text | Free Bible Version
    (245514), -- KJV | text | King James (Authorised) Version
    (253126), -- KJVCPB | text | Cambridge Paragraph Bible of the KJV
    (246913), -- T4T | text | Translation for Translators
    (252265), -- LXXup | text | Brenton English Septuagint (Updated Spelling and Formatting)
    (265137), -- WEBUS | text | World English Bible, American English Edition, without Strong's Numbers
    (240016), -- WEBBE | text | World English Bible British Edition
    (260328), -- LSV | text | Literal Standard Version
    (240017), -- WMB | text | World Messianic Bible
    (254051), -- LSV | text | Literal Standard Version
    (250819), -- Brenton | text | Brenton English translation of the Septuagint
    (240019), -- RV | text | Revised Version 1885
    (240014), -- ASV | text | The Holy Bible, American Standard Version
    (240018), -- WMBBE | text | World Messianic Bible British Edition
    (262699), -- FBV | text | Free Bible Version
    (278101), -- WEBU | text | World English Bible Updated
    (252280), -- EMTV | text | English Majority Text Version
    (245511), -- DRA | text | Douay-Rheims American 1899
    (253125), -- F35 | text | The English New Testament According to Family 35
    (240020), -- WEB | text | World English Bible
    (259557), -- BSB | text | Berean Standard Bible
    (242201), -- WEBBE | text | World English Bible British Edition
    (265856), -- TCENT | text | The Text-Critical English New Testament
    (259032), -- BYZ1904 | text | 1904 Patriarchal Greek New Testament with 20 corrections from later editions
    (265855), -- TCGNT | text | Text-Critical Greek New Testament
    (269494), -- SRGNT | text | Solid Rock Greek New Testament
    (253124), -- F35 | text | The Greek New Testament According to Family 35
    (252266), -- GRCBRENT | text | Brenton Greek Septuagint
    (252238), -- GRCTR | text | Greek Textus Receptus
    (270964), -- WLC | text | The Hebrew Bible, Westminister Leningrad Codex
    (261769); -- HDZP | text | BiblicaÂ® Open Hebrew Living New Testament 2009
    -- Audio Medium Translations
    -- ('',  ); --  | audio |;